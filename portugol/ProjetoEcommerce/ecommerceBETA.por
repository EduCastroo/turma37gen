programa
{
	...
	funcao inicio()
	{
		...
		inteiro codProd = 0,quantidadeProduto=0, verificaQuantidade = 0, m = 0 // A VARIAVEL quantidadeProduto NESTE CODIGO, ESTA OBSOLETA, TENDO EM VISTA QUE FOI SUBSTITUIDA PELO VETOR qtdCarrinho[]
		real valorTotal = 0.0
		cadeia codigo 
		...
		para (c2 = 0; c2 <10; c2++){
			para (c3 = 0; c3 < 2; c3++){
				enquanto (codigo == carrinhoCodProd[c2][c3]){ // CONDICAO DE VERIFICACAO: ENQUANTO CODIGO DO PRODUTO FOR IGUAL A ALGUM carrinhoCODPROD 
					...
					escreva("-ERRO- Produto já selecionado anteriormente")
		...
		*/		
		...
		//qtdCarrinho[c1] = quantidadeProduto
		 //SEU CARRINHO

			escreva("\n\nSEU VETOR CARRINHO ESTA ASSIM: ")
		para(inteiro l = 0; l < 10;  l++){
			escreva(qtdCarrinho[l])
			}
